...
Model: ${details.model},
Year: ${details.year},
Kilometers Driven: ${details.mileage}.
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {features.map((feature) => (
                  <div
                    ...
                    className={`px-3 py-2 rounded-md cursor-pointer border text-sm ${formData.features.includes(feature)
